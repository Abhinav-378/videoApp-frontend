...
function DashBoard() {
  ...
  return (
    <div className="text-white">
      ...
      {/* stats */}
      <div className="flex flex-col justify-between items-start gap-2 py-8 px-2 md:px-8">
        {/* avatar */}
