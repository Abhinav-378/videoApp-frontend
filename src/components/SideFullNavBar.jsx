    ...
    >
      <nav className={`flex flex-row justify-around sm:flex-col sm:mt-16 ${isOpen ? "px-4" : "px-2"}`}>
        ...
        <div className="hidden sm:contents">
          ...
          {/* Collections */}
          <div
            className={`cursor-pointer flex ${isOpen ? "flex-row items-center gap-4" : "flex-col items-center gap-1"} py-2 px-1 hover:bg-[#242424] rounded-xl ${!isOpen && "justify-center"}`}
            ...
            >
              {
                ...
                <img 
                  src={user?.avatar} 
                  alt="user" 
                  className='w-8 h-8 rounded-full shadow-md shadow-purple-500/10 cursor-pointer'
                />:
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
